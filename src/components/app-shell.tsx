...
export function AppShell({children}:{children:React.ReactNode}){
  ...
  const isReferenceHome=pathname==='/';
  ...
  return <ToolOverlayProvider><main className={`octa-page ${collapsed?'sidebar-collapsed':''} ${compact?'is-compact':''} ${isReferenceHome?'is-reference-home':''}`}>
