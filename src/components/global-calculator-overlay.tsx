...
export function GlobalCalculatorOverlay(){
  ...
  return <>
    ...
    {open&&<div ref={panelRef} role="dialog" aria-label="Calculadora flutuante" style={{position:'fixed',left:position.x,top:position.y,zIndex:2147483000,width:390,maxWidth:'calc(100vw - 20px)',border:'1px solid rgba(255,255,255,.18)',borderRadius:28,background:'linear-gradient(145deg,rgba(52,55,59,.66),rgba(14,17,21,.74))',backdropFilter:'blur(32px) saturate(145%)',WebkitBackdropFilter:'blur(32px) saturate(145%)',boxShadow:'0 30px 90px rgba(0,0,0,.46), inset 0 1px 0 rgba(255,255,255,.12)',padding:'14px 14px 16px',overflow:'hidden'}}>
