...
export function GlobalHeroTopNav(){
  ...
  return <>
    <header className={`global-hero-topnav ${path==='/reunioes'?'home-topbar-layout':''}`} aria-label="Navegação principal OCTA">
    ...
    <style jsx global>{`
      ...
      .global-hero-topnav.home-topbar-layout{height:76px;padding:0 28px;gap:24px}
      .global-hero-topnav.home-topbar-layout .global-hero-search{width:370px;height:46px;padding:0 16px;border-radius:24px;background:rgba(18,22,25,.18);backdrop-filter:none;-webkit-backdrop-filter:none}
      .global-hero-topnav.home-topbar-layout .global-hero-search input{font-size:12px;letter-spacing:0}
      .global-hero-topnav.home-topbar-layout .global-hero-links{gap:36px}
      .global-hero-topnav.home-topbar-layout .global-hero-links a{font-size:13px;color:rgba(255,255,255,.84)}
      .global-hero-topnav.home-topbar-layout .global-hero-links a.is-active:after{bottom:-14px;width:4px;height:4px}
      .global-hero-topnav.home-topbar-layout .global-hero-bell{width:38px;height:38px}
      ...
      @media(max-width:1279px){.global-hero-topnav{left:0;height:70px;padding:0 18px;gap:14px;background:none!important;background-color:transparent!important;background-image:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;box-shadow:none!important;border:0!important}.global-hero-search{width:min(360px,42vw);height:42px}.global-hero-links{gap:24px}.global-hero-links a{font-size:14px}.global-hero-topnav.home-topbar-layout{height:70px;padding:0 18px;gap:14px}.global-hero-topnav.home-topbar-layout .global-hero-search{width:min(360px,42vw);height:42px;padding:0 16px}.global-hero-topnav.home-topbar-layout .global-hero-links{gap:20px}.global-hero-topnav.home-topbar-layout .global-hero-links a{font-size:13px}body:has(.global-hero-topnav) .agenda-reference-action{margin-top:70px!important}body:has(.global-hero-topnav) .agenda-reference-grid{height:calc(100dvh - 136px)!important}}
      ...
      @media(max-width:700px){.global-hero-topnav{height:64px;padding:0 12px;background:none!important;background-color:transparent!important;background-image:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;box-shadow:none!important;border:0!important}.global-hero-search{height:40px;padding:0 14px}.global-hero-search input{font-size:12px}.global-hero-bell{size:36px}.global-hero-topnav.home-topbar-layout{height:64px;padding:0 12px}.global-hero-topnav.home-topbar-layout .global-hero-search{height:40px;padding:0 14px}.global-hero-topnav.home-topbar-layout .global-hero-bell{width:36px;height:36px}body:has(.global-hero-topnav) .agenda-reference-action{margin-top:64px!important}body:has(.global-hero-topnav) .agenda-reference-grid{height:calc(100dvh - 130px)!important}}
    `}</style>
  </>;
}
