...
export function GlobalHeroTopNav(){
  ...
  return <>
    ...
    <style jsx global>{`
      .global-hero-topnav{position:fixed;left:250px;right:0;top:0;z-index:59;height:76px;display:flex;align-items:center;gap:24px;padding:0 28px 0 30px;color:#fff;background:linear-gradient(90deg,rgba(82,61,54,.16),rgba(12,20,26,.20));backdrop-filter:blur(14px) saturate(106%);-webkit-backdrop-filter:blur(14px) saturate(106%);border-top:1px solid rgba(255,255,255,.04)}
      ...
      @media(max-width:1279px){.global-hero-topnav{left:0;height:70px;padding:0 18px;gap:14px}.global-hero-search{width:min(360px,42vw);height:42px}.global-hero-links{gap:24px}.global-hero-links a{font-size:14px}}
      ...
      @media(max-width:700px){.global-hero-topnav{height:64px;padding:0 12px}.global-hero-search{height:40px;padding:0 14px}.global-hero-search input{font-size:12px}.global-hero-bell{size:36px}}
    `}</style>
  </>;
}
